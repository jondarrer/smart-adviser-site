  ...
  .init({
    ...
    resources: {
      en: {
        ...
        nav: {
          '/': '/v-next/en',
          '/despre': '/v-next/en/about',
          '/en': '/v-next/en',
          '/en/about': '/v-next/en/about',
          '/v-next': '/v-next/en',
      ...
      ro: {
        ...
        nav: {
          '/': '/v-next',
          '/despre': '/v-next/despre',
          '/en': '/v-next',
          '/en/about': '/v-next/despre',
          '/v-next': '/v-next',
        ...
        service: {
          ...
          'tax-return': 'Declaratia fiscala - £100',
          'registered-as-self-employed': 'Inregistrare ca self-employed - £50',
          'registered-in-cis': 'Inregistrare in CIS (activare UTR) - £30',
          'penalty-appeal': 'Anulare penalitati - de la £50',
          'employment-history': 'Istoric de angajare (apel la HMRC) - £30',
          'set-up-a-company': 'Infiintare companie - £100',
          ...
          'vat-return': 'Declaratia de TVA - £80',
